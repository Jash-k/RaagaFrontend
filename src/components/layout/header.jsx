  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-black/40 border-b border-white/5 px-6 py-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <a href="#" className="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold text-black text-sm font-bold hover:bg-yellow-400"><Play size={16} fill="currentColor" /> Play</a>
      </div>
    </header>
  );
}
